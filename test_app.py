...
class CheatSheetTestCases(unittest.TestCase):
    ...
    def test_categories(self):
        ...
        self.assertFalse(b'This String For Sure wont exist?!' in data)
    ...
    def test_category_crud(self):
        ...
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(teacher_jwt)}
        desc_str = "This is a test category for testing purposes"
        ...
        # Edit the category
        res = self.client().patch('/api/categories/4/update',
                                  headers=self.headers,
                                  json={"name": "TestCat4-E",
                                        "description": desc_str})
        data = json.loads(res.data)
        ...
        # Delete the category
        res = self.client().delete('/api/categories/4',
                                   headers=self.headers)
        data = json.loads(res.data)
    ...
    def test_category_patch_bad_request(self):
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(teacher_jwt)}
        # Passing JSON object without name should result in failure message
        desc = "This is a test category for testing purposes"
        res = self.client().patch('/api/categories/3/update',
                                  headers=self.headers,
                                  json={"description": desc_str})
        data = json.loads(res.data)
    ...
    def test_student_cannot_create_category(self):
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(student_jwt)}
        desc_str = "This is a test category for testing purposes"
        res = self.client().post('/api/categories',
                                 headers=self.headers,
                                 json={"name": "TestCat4",
    ...
    def test_student_cannot_edit_category(self):
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(student_jwt)}
        desc_str = "This is a test category for testing purposes"
        res = self.client().patch('/api/categories/1/update',
                                  headers=self.headers,
                                  json={"name": "TestCat1-E",
                                        "description": desc_str})
        data = json.loads(res.data)
    ...
    def test_topic_crud(self):
        ...
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(teacher_jwt)}
        desc_str = "This is a test topic for testing purposes"
        ...
        # Edit the topic
        res = self.client().patch('/api/topics/4/update',
                                  headers=self.headers,
                                  json={"name": "TestTop4-E",
                                        "description": desc_str})
        data = json.loads(res.data)
        ...
        # Delete the topic
        res = self.client().delete('/api/topics/4',
                                   headers=self.headers)
        data = json.loads(res.data)
    ...
    def test_topic_patch_bad_request(self):
        ...
        # Passing JSON object without name should result in failure message
        desc_str = "This is a test topic for testing purposes"
        res = self.client().patch('/api/topics/3/update',
                                  headers=self.headers,
                                  json={"description": desc_str})
        data = json.loads(res.data)
    ...
    def test_student_cannot_edit_topic(self):
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(student_jwt)}
        desc_str = "This is a test topic for testing purposes"
        res = self.client().patch('/api/topics/1/update',
                                  headers=self.headers,
                                  json={"name": "TestTop1-E",
                                        "description": desc_str})
        data = json.loads(res.data)
    ...
    def test_concept_crud(self):
        ...
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(teacher_jwt)}
        desc_str = "This is a test concept for testing purposes"
        res = self.client().post('/api/concepts',
                                 headers=self.headers,
                                 json={"name": "TestCon4",
                                       "description": desc_str,
                                       "topic_id": 1,
                                       "url": "https://www.original_url.com"})
        data = json.loads(res.data)
        ...
        # Edit the concept
        res = self.client().patch('/api/concepts/4/update',
                                  headers=self.headers,
                                  json={"name": "TestCon4-E",
                                        "description": desc_str,
                                        "url": "https://www.mod_url.com"})
        data = json.loads(res.data)
        ...
        self.assertEqual(editted_cat.url, 'https://www.mod_url.com')
    ...
    def test_concept_patch_bad_request(self):
        ...
        # Passing JSON object without name should result in failure message
        desc_str = "This is a test concept for testing purposes"
        res = self.client().patch('/api/concepts/3/update',
                                  headers=self.headers,
                                  json={"description": desc_str})
        data = json.loads(res.data)
    ...
    def test_student_cannot_edit_concept(self):
        self.headers = {'Content-Type': 'application/json',
                        'Authorization': 'Bearer {}'.format(student_jwt)}
        desc_str = "This is a test concept for testing purposes"
        res = self.client().patch('/api/concepts/1/update',
                                  headers=self.headers,
                                  json={"name": "TestCon1-E",
                                        "description": desc_str,
                                        "url": "https://www.test.com"})
        data = json.loads(res.data)
